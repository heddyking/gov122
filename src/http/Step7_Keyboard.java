...
public class Step7_Keyboard {
	public static Map<String,Object> keyboard(Map<String,Object> p){
		...
		try
		{
			...
			String urlName = "https://"+p.get("Province")+".122.gov.cn/veh1/netxh/getAllHd?JSESSIONID-L="+getSessionId(String.valueOf(p.get("Set-Cookie")));
			System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
