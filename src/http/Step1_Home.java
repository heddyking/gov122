...
public class Step1_Home {
	public static Map<String,Object> home(Map<String,Object> p){
		...
		try
		{
			String urlName = "https://"+p.get("Province")+".122.gov.cn/m/login";
			System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
			...
			r.put("JSESSIONID-L", getSessionId(((List<String>)map.get("Set-Cookie")).get(0)));
			System.out.println("JSESSIONID-L--->" + r.get("JSESSIONID-L"));
